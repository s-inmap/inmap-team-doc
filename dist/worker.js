    ...
    setCurive: function setCurive(points, zoomUnit, nwMc, deltaAngle) {
        for (var j = 0; j < points.length; j++) {
            ...
            for (var k = 0, len = medianCoordinates.length; k < len - 1; k++) {
                ...
                paths = paths.concat((0, _Curive.getPointList)([parseInt(x1), parseInt(y1)], [parseInt(x2), parseInt(y2)], angle));
    ...
    setLineCurive: function setLineCurive(points, zoomUnit, nwMc, n) {
        for (var j = 0; j < points.length; j++) {
            ...
            if (!item.geometry.animationCoordinates) {
                ...
                item.geometry['animationCoordinates'] = (0, _Curive.lineCurive)(item.geometry.coordinates[0], item.geometry.coordinates[1], count);
            }
